                    ...
                    <form class="forms-sample" action="{{ route('doctor.store') }}" method="post"
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                ...
                                <input type="text" name="name" placeholder="Doctor Name" class="form-control @error('name') is-invalid @enderror"
                                    value="{{ old('name') }}">
                                @error('name')
                            ...
                            <div class="col-lg-6">
                                ...
                                <input type="email" name="email" placeholder="Doctor Email Id"  class="form-control @error('email') is-invalid @enderror"
                                    value="{{ old('email') }}">
                                @error('email')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                ...
                                <input type="text" name="address" placeholder="Doctor's Address" 
...
<select name="department" id="department" class="form-control @error('department') is-invalid @enderror" value="{{ old('department') }}">
    <option value="">Select</option>
